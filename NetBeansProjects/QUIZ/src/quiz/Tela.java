...
public class Tela extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton2.setFont(new java.awt.Font("Tunga", 3, 14)); // NOI18N
        jButton2.setText("MORE");

        jButton3.setBackground(new java.awt.Color(255, 102, 102));
        jButton3.setFont(new java.awt.Font("Tunga", 3, 14)); // NOI18N
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/naruto_render__1__by_mitsakii-d3e3gu4.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
          ...
          String home =System.getProperty("user.home");
           File file = new File(home+"/"+player+".txt");
//           File file = new File("home/aluno/"+player+".txt");
